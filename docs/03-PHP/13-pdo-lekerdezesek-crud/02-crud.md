---
id: pdo-crud
slug: /php/pdo-lekerdezesek-crud/crud
...
foreach ($stmt as $sor) {
    echo htmlspecialchars($sor["nev"], ENT_QUOTES, "UTF-8") . " (" . (int) $sor["kor"] . ") ";
...
<form method="POST">
    <input type="text" name="nev" value="<?= htmlspecialchars($diak['nev'], ENT_QUOTES, 'UTF-8') ?>">
    <input type="number" name="kor" value="<?= (int) $diak['kor'] ?>">
    <button type="submit">Mentés</button>
</form>
